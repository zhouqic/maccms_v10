...
var MAC={
    ...
    'History': {
        ...
        'Init':function(){
			...
			html += '<div class="watch-list-inner"></div>';
            html +='<p><a href="javascript:void(0)" onclick="MAC.History.Clear();">清空全部播放记录</a><a class="close-his" href="javascript:void(0)" onclick="MAC.History.Hide();">关闭</a></p>';
